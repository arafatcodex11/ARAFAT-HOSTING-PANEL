...
app = Flask(__name__)
app.secret_key = 'arafat-super-secret-key-2026'
...
def create_default_files(server_dir):
    ...
    if not os.path.exists(main_py):
        with open(main_py, 'w', encoding='utf-8') as f:
            f.write('''# ARAFAT HOSTING - Default Bot
import time

print("=" * 40)
print("Bot is running on ARAFAT HOSTING")
...
def api_create_server():
    ...
    if not username:
        username = f"ARAFAT_FLEX{random.randint(10000, 99999)}"
